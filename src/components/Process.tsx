          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative h-44 overflow-hidden">
                ...
                />
                {/* Step number */}
                <div className="absolute top-4 left-4 bg-amber-400 text-stone-900 font-bold text-xl font-montserrat font-extrabold w-10 h-10 rounded-full flex items-center justify-center shadow-md">
                  {step.number}
                </div>
              </div>
              ...
              <div className="p-5">
                ...
                <h3 className="font-montserrat font-extrabold text-xl font-bold text-white mb-2">{step.title}</h3>
