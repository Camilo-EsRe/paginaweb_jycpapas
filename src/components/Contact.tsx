            ...
            <div className="bg-stone-800 border border-stone-700 rounded-2xl p-8">
              {sent ? (
                <div className="text-center py-10">
                  ...
                  <h3 className="font-playfair text-2xl font-bold text-white mb-2">Mensaje enviado</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <h3 className="font-playfair text-xl font-bold text-white mb-5">Formulario de contacto</h3>
