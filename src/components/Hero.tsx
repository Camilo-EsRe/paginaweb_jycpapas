  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Headline */}
        <h1 className="font-playfair text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-tight mb-6 animate-slide-up">
          J&C<br />
          <span className="text-amber-300 italic">PAPAS</span>
        </h1>

        {/* Subheadline */}
        <p className="text-stone-200 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-inter font-light animate-slide-up-delay">
        ...
        <div className="mt-16 grid grid-cols-3 gap-4 max-w-lg mx-auto animate-fade-in-slow">
          {[
            ...
            <div key={s.label} className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-amber-300 font-playfair">{s.value}</div>
